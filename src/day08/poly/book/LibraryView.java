...
public class LibraryView {
    ...
    // static필드의 초기화는 static initializer를 사용 -> 우리가 호출하는거 아니고 프로그램 실행시 자동으로 호출됨
...
//        makeNewBookUser();
    ...
    private static void selectMenu() {
        ...
        switch (menuNum) {
            ...
            case "5":
                String author=input("저자이름을 입력해 주세요. : ");
                Book authorBook = repository.findAuthor(author);
                if(authorBook!=null){
                    System.out.println(authorBook.info());
                }else{
